...
; not the right format - I should probably not have a list here...
; but maybe not needed at all - for now I stick it in the lets of apicall
;(defun build-extra-headers (current-time-stamp json-content)
;  (list (cons "X-Mcash-Timestamp" current-time-stamp)
...
;;; The following are some utils that should be put in a separate file
;;;
